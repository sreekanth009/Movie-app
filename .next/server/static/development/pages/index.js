...
const Index = props => (console.log('data', props.data), console.log('dataList', props.dataList), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Container__WEBPACK_IMPORTED_MODULE_2___default.a, {
  fixed: true,
  __source: {
  ...
  __self: undefined
}, "Movie Name")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_3___default.a, {
  item: true,
  xs: 6,
  __source: {
    fileName: _jsxFileName,
...
Index.getInitialProps = async function () {
  ...
  const resMovie = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_1___default()(`${baseUrl}?api_key=8e0bc1114b862d78c97488527814d264&language=en-US`);
  const data = await resMovie.json();
  const resMovieList = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_1___default()(`${baseUrl}/similar?api_key=8e0bc1114b862d78c97488527814d264&language=en-US&page=1`);
...
module.exports = __webpack_require__(/*! /Users/Sreekanth/Documents/other/Movie-app/pages/index.js */"./pages/index.js");
